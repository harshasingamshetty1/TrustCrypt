...
import { GET_CREDENTIALS_QUERY } from "../lib/helper";
...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>TrustCrypt - Password Manager</title>
        <meta name="description" content="TrustCrypt - Password Manager" />
      ...
      <main className={styles.main}>
        ...
        {provider && (
          <>
            <h2 className="text-3xl text-center p-5">My Passwords</h2>
            <Space>
              <Input.Search
